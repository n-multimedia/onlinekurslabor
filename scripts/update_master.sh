...
drush fr notification_features nm_section_courses_features videosafe_features nm_section_content_features annvid_features nm_h5p_features  nm_uuid_features --yes
