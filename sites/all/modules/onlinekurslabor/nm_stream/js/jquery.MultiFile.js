    ...
    (function($) {
        ...
        $.fn.MultiFile = function(options) {
            ...
            this
                ...
                //24.03.2014 - 13:01 - SN
                //nm_stream adaption to allow using classes and not having to bind fileupload lists to unique ids
                MultiFile.list = $(this).parent().parent().parent().find(MultiFile.list);
