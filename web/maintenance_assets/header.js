...
(function ($) {
    ...
    Drupal.behaviors.collapse_wrapper = {
        ...
        /*Auf groÃŸen Devices ist wrapping deaktiviert. Dann sollen auch alle Layer verschwinden.
        ...
        handleWrapperLayout: function ()
        {
            ...
            if ($("#views-view-collapse--button").is(":hidden"))
            {
                ...
                //scrollheight = tatsÃ¤chliche content-length
...
;
Drupal.locale = { 'pluralFormula': function ($n) { return Number(($n!=1)); }, 'strings': {"":{"An AJAX HTTP error occurred.":"Ein AJAX-HTTP-Fehler ist aufgetreten.","HTTP Result Code: !status":"HTTP-R\u00fcckgabe-Code: !status","An AJAX HTTP request terminated abnormally.":"Eine AJAX-Anfrage ist abnormal beendet worden.","Debugging information follows.":"Im Folgenden finden Sie Debugging-Informationen.","Path: !uri":"Pfad: !uri","StatusText: !statusText":"Statustext: !statusText","ResponseText: !responseText":"Antworttext: !responseText","ReadyState: !readyState":"ReadyState: !readyState","@title dialog":"@title Dialog","Loading":"Laden","(active tab)":"(aktiver Reiter)","Edit":"Bearbeiten","Select all rows in this table":"Alle Zeilen dieser Tabelle ausw\u00e4hlen","Deselect all rows in this table":"Alle Zeilen dieser Tabelle abw\u00e4hlen","Hide":"Ausblenden","Show":"Anzeigen","Autocomplete popup":"Popup zur automatischen Vervollst\u00e4ndigung","Searching for matches...":"Suche \u2026","Please wait...":"Bitte warten...","Re-order rows by numerical weight instead of dragging.":"Zeilen mittels numerischer Gewichtung ordnen statt mit Drag-and-Drop","Show row weights":"Zeilenreihenfolge anzeigen","Hide row weights":"Zeilenreihenfolge ausblenden","Drag to re-order":"Ziehen, um die Reihenfolge zu \u00e4ndern","Changes made in this table will not be saved until the form is submitted.":"\u00c4nderungen in dieser Tabelle werden nicht gespeichert, bis dieses Formular abgesendet wurde.","Automatic alias":"Automatischer Alias","Alias: @alias":"Alias: @alias","No alias":"Kein Alias","Not in book":"Nicht im Buch","New book":"Neues Buch","New revision":"Neue Version","No revision":"Keine Version","By @name on @date":"Von @name am @date","By @name":"Von @name","Not published":"Nicht ver\u00f6ffentlicht","@number comments per page":"@number Kommentare pro Seite","The selected file %filename cannot be uploaded. Only files with the following extensions are allowed: %extensions.":"Die ausgew\u00e4hlte Datei %filename konnte nicht hochgeladen werden. Nur Dateien mit den folgenden Erweiterungen sind zul\u00e4ssig: %extensions.","Enabled":"Aktiviert","Disabled":"Deaktiviert","Hide summary":"Zusammenfassung verbergen","Edit summary":"Zusammenfassung bearbeiten","Not in menu":"Nicht im Men\u00fc","Media browser":"Medienbrowser","Title":"Titel","Default":"Standard","Key":"Schl\u00fcssel","Author":"Autor","Add":"Hinzuf\u00fcgen","Customize dashboard":"Dashboard anpassen","Status message":"Statusmeldung","Submit":"Absenden","Remove":"Entfernen","Next":"Weiter","Cancel":"Abbrechen","Download":"Herunterladen","none":"keine","Sunday":"Sonntag","Monday":"Montag","Tuesday":"Dienstag","Wednesday":"Mittwoch","Thursday":"Donnerstag","Friday":"Freitag","Saturday":"Samstag","Refresh":"Aktualisieren","Configure":"Konfigurieren","Done":"Fertig","Year":"Jahr","N\/A":"n. v.","OK":"OK","Prev":"Vorheriges","Mon":"Mo","Tue":"Di","Wed":"Mi","Thu":"Do","Fri":"Fr","Sat":"Sa","Sun":"So","January":"Januar","February":"Februar","March":"M\u00e4rz","April":"April","May":"Mai","June":"Juni","July":"Juli","August":"August","September":"September","October":"Oktober","November":"November","December":"Dezember","Today":"Heute","Jan":"Jan","Feb":"Feb","Mar":"M\u00e4r","Apr":"Apr","Jun":"Jun","Jul":"Jul","Aug":"Aug","Sep":"Sep","Oct":"Okt","Nov":"Nov","Dec":"Dez","Su":"So","Mo":"Mo","Tu":"Di","We":"Mi","Th":"Do","Fr":"Fr","Sa":"Sa","mm\/dd\/yy":"mm\/tt\/jj","The changes to these blocks will not be saved until the \u003Cem\u003ESave blocks\u003C\/em\u003E button is clicked.":"Die \u00c4nderungen an diesen Bl\u00f6cken werden nicht gespeichert, bis auf dem \u003Cem\u003EBl\u00f6cke speichern\u003C\/em\u003E-Button geklickt wurde.","This permission is inherited from the authenticated user role.":"Diese Berechtigung wird von der Rolle \u201aAuthentifizierte Benutzer\u2018 ererbt.","Requires a title":"Ben\u00f6tigt einen Titel","Not restricted":"Uneingeschr\u00e4nkt","Not customizable":"Nicht anpassbar","Restricted to certain pages":"Auf bestimmte Seiten eingeschr\u00e4nkt","The block cannot be placed in this region.":"Der Block kann nicht in dieser Region abgelegt werden.","Don\u0027t display post information":"Beitragsinformationen nicht anzeigen","Select":"Ausw\u00e4hlen","Destination: @scheme":"Pfad: @scheme","Associated with @name":"Verkn\u00fcpft mit @name ","Search outline...":"Gliederung durchsuchen...","Expand all":"Alles ausklappen","Collapse all":"Alles einklappen","Error loading the PDF!":"Fehler beim Laden des PDFs!"}} };;
	...
	//console.debug(all_interactions);
      ...
      /*      Drupal.behaviors.h5p_annotationlist.convertElementToVideoSeekable('#h5p_annotationlist_' + video.contentId, video);*/
        ...
        SortfunctionForAnnotations: function(sortby_what)
        {
            ...
            //sortierung nach title, groÃŸkleinschreibung egal
...
;
//mÃ¶chte man neben pdf und video einen weiteren jump-typ einfÃ¼gen, der im hash erscheint, muss man hier refactoren und die pdf-/video-eintrÃ¤ge ergÃ¤nzen
(function($) {
...
(function($) {
    Drupal.behaviors.h5p_connector_api = {
        ...
        /*wegen h5p-api-changes wird nun vor ausfÃ¼hrung immer die version geprÃ¼ft und auch bei minor-changes ein fehler geworfen*/
    ...
    Drupal.behaviors.h5p_connector_api.event = {
        ...
        /*       (*) RÃ¼ckgabe: form  [["pdf", "8"], ["video", "260"]]*/
         ...
         * muss hÃ¤ndisch aufgerufen werden
         * 
         */
...
/*
 * WRAPPER fÃ¼r H5p-Audio und H5P-Interactive-Video
 */
    Drupal.behaviors.h5p_connector_api.av_player = {
        last_seen_time: null,//zuletzt geprÃ¼fte zeit
        ...
        /**
         * Helper-Function fÃ¼r initialize.
         * PrÃ¼ft regelmÃ¤ÃŸig, ob H5P-AV schon initialisiert ist und setzt die Variable av_object
         * @returns {undefined}
         */
         ...
         * AV benÃ¶tigt lÃ¤nger, bis es geladen und initialisiert ist, deswegen diese Funktion als Pendant 
         * @param {type} callback
         * @returns {undefined}
         */
     ...
     /*   getH5P: function()
        ...
        /*
         * Problem: das drupal-filesystem ist nicht das schnellste und wenn man zu frÃ¼h auf Play drÃ¼ckt,
        ...
        {
            var loading_animation = '<div class="h5p_connector_loading_inner"><h3>lÃ¤dt</h3><div>';   
        ...
        { 
            ...
            switch(this.av_object['type'])
            {
                ...
                case 'video':
                    ...
                    //timeUpdate muss man bisschen verzÃ¶gern
        ...
        /*
         * hole momentane zeit im player. leichter versatz im sekundenbereich mÃ¶glich!!!
        ...
        ,
        /*
         * prÃ¼ft ob der player weitergelaufen ist
         * private function
         */
        checkTime: function()
        {
...
jQuery(window).on('hashchange', function(e) {
    //nach umleitung auf hash: entsprechende befehle durchfÃ¼hren
...
(function($) {
    Drupal.behaviors.html5pdf = {
        ...
        {
          //  todo alert("renderer braucht ein event on resize, das angesprochen werden kann, da grÃ¶ÃŸe nicht definierbar");
            ...
            CKEDITOR.dialog.add(options["dialog_id"], function(editor) {
                ...
                return {
                    ...
                    onShow: function()
                    {
                        ...
                        /*hier folgte eine lÃ¤ngere auflistung der better-autocomplete-funktionalitÃ¤t
...
(function($) {
    ...
    Drupal.behaviors.mediamodule_fix = {
         ...
         */
        attach: function(context, settings) {
            //typprÃ¼fung, ob plugin benÃ¶tigt
            if (typeof Drupal.media !== "undefined" && typeof Drupal.media.filter !== "undefined")
            {
                ...
                {   //problem: in der originalfunktion ist nach dem span-tag kein separator. ckeditor verschluckt sich dann nach enter.
                    ...
                    //prinzipiell verantwortlich ist https://dev.ckeditor.com/ticket/6955 => begrÃ¼ndung https://www.drupal.org/node/2153851#comment-8697585
 ...
 * und
 * Ã„ndert Verhalten des Form-Reset-Buttons ("Alle")
 */
...
(function($) {
    ...
    Drupal.behaviors.section_home = {
        ...
        attach: function(context, settings) {
            ...
            //neues behaviour fÃ¼r reset-button("alle")
...
(function ($) {
    ...
    Drupal.behaviors.section_courses.menu = {
        //die Links im KursmenÃ¼ haben ein default-Ziel. der Link soll nicht auf eine andere Seite fÃ¼hren, wenn wir ins MenÃ¼ klicken.
