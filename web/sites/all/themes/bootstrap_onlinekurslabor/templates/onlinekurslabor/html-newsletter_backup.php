...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <style type="text/css">
			...
			*/
			h1{
				/*@editable*/ color:#0088CC !important;
				display:block;
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                        <tr>
                                            <td valign="top" class="headerContent">
                                            	<img src="<?= theme_get_setting('logo', 'bootstrap_onlinekurslabor')?>" style="max-width:600px; margin-left:20px;" id="headerImage" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- // END HEADER -->
                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateFooter">
                                      <tr>
                                            <td valign="top" class="footerContent" style="padding-top:0;" mc:edit="footer_content00">
                                                <br />
                                                <em>Sie erhalten diese Mail, da Sie im Onlinekurslabor registriert sind.</em>
                                                <br />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td valign="top" class="footerContent" style="padding-top:0; padding-bottom:40px;" mc:edit="footer_content01">
