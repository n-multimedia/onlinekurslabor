...
foreach ($kurs_dozent_objects as $dozent_acc) {
  ...
  if (isset($dozenten_profile->field_photo)) {
    ...
    $dozenten_acc_pic =
      '<img src="' . (image_style_url('profile_mini_thumbnail', $dozenten_acc_picture_field['#items'][0]['uri'])) .
      '" style="padding:2px;" class="courseitem_image_hover_transp" title="' . $dozent_realname . '"/>';
