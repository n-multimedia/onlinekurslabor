...
(function($) {
    Drupal.behaviors.videosafe = {
          ...
          initialize: function()
        {  //gnaaz dummer chrome braucht noch ne sekunde 
            Drupal.behaviors.h5p_connector_api.onH5Pready(function(){ setTimeout(function(){Drupal.behaviors.videosafe.checkVideoStatus();}, 1000);});
