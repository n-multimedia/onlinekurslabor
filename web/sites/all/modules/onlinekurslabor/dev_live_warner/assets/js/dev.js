...
jQuery(document).ready(function() {
    ...
    {   //falls style grad nicht resetted ist, dev anzeigen
        ...
        jQuery("body").addClass("dev");
    jQuery("body.dev #page_top_navigation").prepend('<a id="reset_style" href="#" class="pull-left">Reset Style</a>');
    jQuery("#reset_style").click(function() {
        jQuery(this).remove();
        jQuery("body").removeClass("dev")
    });
    ...
    jQuery("#goto_dev").click(function() {
        devliveplugin_createCookie("dev_overlay_skip", "ja", 30);
