 ...
 * @author Bernhard
 */
class CourseCreate extends CourseBase implements \Page\node\NodeCreateInterface {
    ...
    public function fillFields(\AcceptanceTester $I, \Codeception\Example $params) {
        ...
        //calendar überdeckt SAVE-Button. 
        $I->clickWithLeftButton(null, 1, 1); //klicke in ein eck, um calendar zu verstekcen
